//*************************************************************************
// Data file for UTF-8 user defined fonts
// Modified for Bar Graph Display.
//
#ifndef FONTS_DATA_H
#define FONTS_DATA_H

// Bargraph special characters
#define BAR_WIDTH_1 0x01                              // bar 1 pixel
#define BAR_WIDTH_2 0x02                              // bar 2 pixels
#define BAR_WIDTH_3 0x03                              // bar 3 pixels
#define BAR_WIDTH_4 0x04                              // bar 4 pixels
#define BAR_WIDTH_5 0x05                              // bar 5 pixels
#define BAR_WIDTH_6 0x06                              // bar 6 pixels
#define BAR_WIDTH_7 0x07                              // bar 7 pixels
#define BAR_WIDTH_8 0x08                              // bar 8 pixels
#define BAR_SCALE   0x09                              // scale mark
#define BAR_BOL     0x0a                              // bolleke
#define BAR_TOP     0x0b                              // top
#define BAR_HALF_SCALE 0x0c                           // half scale mark
#define BAR_BREAK_3 0x0d                              // broken 3 (top)
#define BAR_BREAK_2 0x0e                              // broken 2 (top)
#define BAR_BREAK_1 0x0f                              // broken 1 (top)
#define BAR_BLANK_1 0x10                              // blank 1 pixel
#define BAR_BLANK_2 0x11                              // blank 2 pixels
#define BAR_BLANK_3 0x12                              // blank 3 pixels
#define BAR_BLANK_4 0x13                              // blank 4 pixels
#define BAR_BLANK_5 0x14                              // blank 5 pixels
#define BAR_BLANK_6 0x15                              // blank 6 pixels
#define BAR_BLANK_7 0x16                              // blank 7 pixels
#define BAR_BLANK_8 0x17                              // blank 8 pixels

// Dot matrix data
MD_MAX72XX::fontType_t ExtASCII[] PROGMEM = {
  0,                                                  // 0  - Unused
  1, 0x3c,                                            // 1  - 'Segment 1'
  2, 0x3c, 0x3c,                                      // 2  - 'Segment 2'
  3, 0x3c, 0x3c, 0x3c,                                // 3  - 'Segment 3'
  4, 0x3c, 0x3c, 0x3c, 0x3c,                          // 4  - 'Segment 4'
  5, 0x3c, 0x3c, 0x3c, 0x3c, 0x3c,                    // 5  - 'Segment 5'
  6, 0x3c, 0x3c, 0x3c, 0x3c, 0x3c, 0x3c,              // 6  - 'Segment 6'
  7, 0x3c, 0x3c, 0x3c, 0x3c, 0x3c, 0x3c, 0x3c,        // 7  - 'Segment 7'
  8, 0x3c, 0x3c, 0x3c, 0x3c, 0x3c, 0x3c, 0x3c, 0x3c,  // 8  - 'Segment 8'
  1, 0xff,                                            // 9  - 'Scale'
  8, 0x3c, 0x7e, 0xff, 0xff, 0xff, 0xff, 0x7e, 0x3c,  // 10 - 'Bottom'
  1, 0x18,                                            // 11 - 'Top'
  1, 0x7e,                                            // 12 - 'Half scale'
  1, 0x1c,                                            // 13 - 'Break 3'
  1, 0x0c,                                            // 14 - 'Break 2'
  1, 0x04,                                            // 15 - 'Break 1'
  1, 0,                                               // 16 - 'Blank 1'
  2, 0, 0,                                            // 17 - 'Blank 2'
  3, 0, 0, 0,                                         // 18 - 'Blank 3'
  4, 0, 0, 0, 0,                                      // 19 - 'Blank 4'
  5, 0, 0, 0, 0, 0,                                   // 20 - 'Blank 5'
  6, 0, 0, 0, 0, 0, 0,                                // 21 - 'Blank 6'
  7, 0, 0, 0, 0, 0, 0, 0,                             // 22 - 'Blank 7'
  8, 0, 0, 0, 0, 0, 0, 0, 0,                          // 23 - 'Blank 8'
  0,                                                  // 24 - Unused
  0,                                                  // 25 - Unused
  0,                                                  // 26 - Unused
  0,                                                  // 27 - Unused
  ...
  5, 35, 19, 8, 100, 98,                              // 37 - '%'
  5, 54, 73, 86, 32, 80,                              // 38 - '&'
  2, 4, 3,                                            // 39 - 'Right single quote mark'
  3, 28, 34, 65,                                      // 40 - '('
  3, 65, 34, 28,                                      // 41 - ')'
  ...
  2, 3, 4,                                            // 96 - 'Left single quote mark'
  ...
  5, 96, 254, 249, 254, 96,                           // 209 - TEMPERATURE sign
  ...
  5, 112, 140, 131, 140, 112,                         // 241 - HUMIDITY sign
